        ...
        var a = e("./GameManager")
          ...
          , f = function(e) {
            ...
            t.prototype.adsButtonFunc2 = function() {
                window.location.href = "https://db.yaozh.com"
            }
            ,
          ...
          , p = function(e) {
            ...
            t.prototype.onTouchEnd = function(e) {
                ...
                this.scheduleOnce(function() {
                    ...
                    t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(s.default.RandomInteger(window.difficulty[0], window.difficulty[1])),
                    t.createFruitCount++))
                }, .5))
            }
            ,
        ...
        var a = e("../common/PlayerInfo")
          ...
          , h = function(e) {
            ...
            t.prototype.adsButtonFunc = function() {
                window.location.href = "http://db.yaozh.com"
            }
            ,
            ...
            t.prototype.UpdateScoreLabel = function(e) {
                if (this.isScoreChange) {
                    ...
                    this.currentScore = this.currentScore * (window.difficulty[0] + 1);
                    this.currentScore = this.currentScore * chengjifanbei;
    ...
    MainManage: [function(e, t, n) {
          ...
          , r = (e("GameUiTools"),
        {
            ...
            getHttpGameId: function() {
                ...
                var c = document.URL
                  , a = 0
                  , i = c.substring(c.lastIndexOf("/index/") + 1, c.length).split("/");
                i.length >= 2 && (a = i[1]),
                this.gameHttpId = a,
                cc.log("gameId", a);
